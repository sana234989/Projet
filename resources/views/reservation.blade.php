...
<body  class="bg-gray-200">
    ...
    <div class="general card flex justify-center items-center h-auto">
        ...
        <div class="intro grid grid-cols-2 gap-4">
            <h4 class="title">welcome to our restaurant</h4>
            <p class="text"> 
                Bienvenue dans le restaurant de notre hôtel, où chaque repas est une expérience délicieuse imprégnée de sophistication et de convivialité.
                 Niché au cœur de notre établissement,<br>notre restaurant offre bien plus qu'une simple cuisine exquise ,nos chefs talentueux<br> créent des plats raffinés qui éveillent les sens et enchantent les papilles. </p>
             {{-- ici le div de 1 ere card--}}    
          <div class="carde1 max-w-sm rounded overflow-hidden shadow-lg" id="card1">
            <img class="w-full" src="{{ asset('image/frensh.png') }}" alt="Image 1">
            <div class="px-6 py-4">
          ...
          <div class="carde1 max-w-sm rounded overflow-hidden shadow-lg"id="card2">
            <img class="w-full" src="{{ asset('image/chinoise.png') }}" alt="Image 2">
            <div class="px-6 py-4">
          ...
          <div class="carde1 max-w-sm rounded overflow-hidden shadow-lg" id="card3">
            <img class="w-full" src="{{ asset('image/marocain2.jpg') }}" alt="Image 3">
            <div class="px-6 py-4">
...
Un restaurant marocain offre une expérience culinaire riche et variée, imprégnée des saveurs exotiques et des traditions de la cuisine du Maroc. Les plats sont souvent préparés avec des ingrédients frais et des épices aromatiques, 
          ...
          <div class="carde1 max-w-sm rounded overflow-hidden shadow-lg" id="card4">
            <img class="w-full" src="{{ asset('image/espagnol.png') }}" alt="Image 4">
            <div class="px-6 py-4">
              <div class="titre font-bold text-xl mb-2">Espagnol restaurant</div>
              <p class="text-gray-700 text-base">
                La cuisine espagnol fait référence à divers styles gastronomiques dérivés de la tradition française. Elle a évolué au cours des siècles, suivant ainsi les changements sociaux et politiques du pays
